		...
		<div class="col-md-5" style="margin-left: 40px">
			<form method="post" action="{{ route('jadwal.store') }}">
			  ...
			  <div class="form-group">
			    ...
			    <input type="time" class="form-control" id="exampleInputPassword1" placeholder="Masukkan no hp" name="jam_buka">
			  </div>
			  <div class="form-group">
			    <label for="exampleInputPassword1">Jam Tutup</label>
			    <input type="time" class="form-control" id="exampleInputPassword1" placeholder="Masukkan no hp" name="jam_tutup">
			  </div>
